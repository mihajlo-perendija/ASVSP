...
spark = SparkSession \
    .builder \
    .appName("Count crimes by police district") \
    .config("spark.mongodb.output.uri", "mongodb://asvsp:asvsp@mongo:27017/asvsp.count_by_district?authSource=admin") \
    .getOrCreate()
