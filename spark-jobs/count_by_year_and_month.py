...
spark = SparkSession \
    .builder \
    .appName("Count crimes by year and month") \
    .config("spark.mongodb.output.uri", "mongodb://asvsp:asvsp@mongo:27017/asvsp.count_by_year_and_month?authSource=admin") \
    .getOrCreate()
